        ...
        <div class="row">
            <div class="col">
            	...
            	<table class="table" style="margin-bottom: 30px;">
					<tr>
						<td width="180px" align="left" class="page-title" style="border-bottom: 3px solid #CF1C31; border-top:none; ">관리자 관리</td>
                ...
                <div class="d-flex justify-content-between mb-2 align-items-center">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <a href="${pageContext.request.contextPath}/admin/admin/account" class="btn btn-primary">
