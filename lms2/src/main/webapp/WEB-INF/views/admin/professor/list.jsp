		...
		<div class="main-wrapper">
            <div class="col">
	            <table class="table" style="margin-bottom: 30px;">
					<tr>
						<td width="180px" align="left" style="border-bottom: 3px solid #CF1C31; border-top:none; font-size: 30px; padding-bottom: 0px;">교수 관리</td>
                    ...
                    <table class="table table-bordered table-hover text-center align-middle">
                        ...
                        <tbody>
                        	...
                        	<c:if test="${empty list}">
                        		<tr><td colspan="7">등록된 관리자가 없습니다.</td></tr>
                        	</c:if>
                        </tbody>
					...
					<div class="row board-list-footer justify-content-between align-items-center mt-3">
					    <div class="col-auto">
					        <button type="button" class="btn btn-light"
					            onclick="location.href='${pageContext.request.contextPath}/admin/professor/list';"
					    ...
					    <div class="col d-flex justify-content-center">
					        <form name="searchForm" class="d-flex align-items-center gap-2">
					            <select name="schType" class="form-select" style="width: 140px;">
					                <option value="all" ${schType=="all"?"selected":""}>사번+이름</option>
...
function changeList() {
    ...
    location.href = '${pageContext.request.contextPath}/admin/professor/list?' + params;
}
