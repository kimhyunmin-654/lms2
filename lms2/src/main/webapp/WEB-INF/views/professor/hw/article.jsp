					...
					<div class="body-main">
						...
						<table class="table board-article">
							...
							<tbody>
								...
								<c:if test="${not empty dto.save_filename}">
									<td colspan="2" align="justify"><i class="fa-solid fa-floppy-disk"></i>&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/lecture/download?num=${dto.homework_id}">${dto.original_filename}</a>
									</td>
								</c:if>
						...
						<table class="table table-borderless mb-2">
							<tr>
								...
								<td class="text-end">
									<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/professor/hw/update?num=${dto.homework_id}&page=${page}&lecture_code=${lecture_code}';">수정</button>
	...
	<script type="text/javascript">
		...
		function deleteArticle() {
		    if (confirm('게시글을 삭제하시겠습니까?')) {
		    	let params = 'num=${dto.homework_id}&page=${page}&lecture_code=${lecture_code}';
		    	let url = '${pageContext.request.contextPath}/professor/hw/delete?' + params;
		    	location.href = url;
		    }
		}
